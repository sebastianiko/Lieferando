...
let dishDescriptions = [
    "6 Rolls 16 Maki 12 Nigiri",
    "12 Rock-Rolls 12 Maki 8 Nigiri",
    "8 Tiger-Rolls 24 Sake-Maki",
    "8 Maki 16 Sake-Maki",
    "16 Nigiri 6 Maki 12 Sashimi",
    "2 Sushi-Balls 20 Maki 8 Temaki",
    "4 Maki 6 Nigiri",
    "8 Maki 16 Sake-Maki",
    "6 Rolls",
    "16 Maki",
   ...
   <div id="delivery-options">
      <div class="delivery-options">
         <div
            ...
            >
            <img src="img/bike.png" alt="bike" class="bike" />
            <div>
         ...
         <div id="pick-up" onclick="choosePickUpOption(${totalSum})">
            <img src="img/pick-up.png" alt="bike" class="bike" />
            <div>
...
<div class="sumsSeperator">Lieferkosten: <div>${formattedDeliveryCosts}€</div></div>`;
    ...
    document.getElementById(
        "orderButton"
    ).innerHTML = /*html*/ `<button id="orderButtonContent" onclick="submitOrder(${calculateBasketSum})"><b>Jetzt bestellen</b></button>`;
}
...
<div id="${dish}" class="dishes">
   ...
   <div class="menuimg-and-addbutton">
      <img
         ...
         class="dishes-imgs"
         />
      <img src="img/add.png" alt="add" class="add-button" onclick="addToBasket('${dish}', ${price})"/>
   </div>
</div>`;
}
...
function renderBasketButton() {
    ...
    ).innerHTML = /*html*/ `<button class="basketButton" onclick="openMobileBasket()">${formattedTotalSum}€</button>`;
}
...
function calculateBasketButton(calculateBasketSum) {
    ...
    document.getElementById(
        "basketButtonContainer"
    ).innerHTML = /*html*/ `<button class="basketButton" onclick="openMobileBasket()">${formattedSubSum}€</button>`;
}
